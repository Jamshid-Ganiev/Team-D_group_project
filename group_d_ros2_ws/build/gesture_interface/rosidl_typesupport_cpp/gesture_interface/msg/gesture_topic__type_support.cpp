...
static const _GestureTopic_type_support_symbol_names_t _GestureTopic_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gesture_interface, msg, GestureTopic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gesture_interface, msg, GestureTopic)),
  }
};
...
{
  return &::gesture_interface::msg::rosidl_typesupport_cpp::GestureTopic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gesture_interface, msg, GestureTopic)() {
  return get_message_type_support_handle<gesture_interface::msg::GestureTopic>();
}
